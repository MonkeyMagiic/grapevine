...
function renderGraph(data) {
	...
	var line = d3.svg.line()
		.x(function(d : DataBlob) { return x(parseDate(d.TIME_PERIOD)); })
		.y(function(d : DataBlob) { return y(parseFloat(d.OBS_VALUE)); });
	...
	x.domain(d3.extent(data, function(d : DataBlob) { return parseDate(d.TIME_PERIOD); }));
	y.domain(d3.extent(data, function(d : DataBlob) { return parseFloat(d.OBS_VALUE); }));
